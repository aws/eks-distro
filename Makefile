...
makes:
	...
	make -C projects/coredns/coredns clean
	...
	make -C projects/kubernetes-csi/external-attacher clean
	...
	make -C projects/kubernetes-csi/external-provisioner clean
	...
	make -C projects/kubernetes-csi/external-resizer clean
	...
	make -C projects/kubernetes-csi/external-snapshotter clean
	...
	make -C projects/kubernetes-csi/livenessprobe clean
	...
	make -C projects/kubernetes-csi/node-driver-registrar clean
	...
	make -C projects/kubernetes-sigs/metrics-server clean
	...
	make -C projects/kubernetes/release clean
