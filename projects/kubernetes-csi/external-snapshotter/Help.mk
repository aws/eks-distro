...
_output/bin/external-snapshotter/linux-amd64/snapshot-controller: ## Build `_output/bin/external-snapshotter/linux-amd64/snapshot-controller`
_output/bin/external-snapshotter/linux-amd64/csi-snapshotter: ## Build `_output/bin/external-snapshotter/linux-amd64/csi-snapshotter`
_output/bin/external-snapshotter/linux-amd64/snapshot-validation-webhook: ## Build `_output/bin/external-snapshotter/linux-amd64/snapshot-validation-webhook`
_output/bin/external-snapshotter/linux-arm64/snapshot-controller: ## Build `_output/bin/external-snapshotter/linux-arm64/snapshot-controller`
_output/bin/external-snapshotter/linux-arm64/csi-snapshotter: ## Build `_output/bin/external-snapshotter/linux-arm64/csi-snapshotter`
_output/bin/external-snapshotter/linux-arm64/snapshot-validation-webhook: ## Build `_output/bin/external-snapshotter/linux-arm64/snapshot-validation-webhook`
