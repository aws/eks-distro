...
require (
	...
	k8s.io/csi-translation-lib v0.21.5
...
replace k8s.io/code-generator => k8s.io/code-generator v0.21.5

replace k8s.io/cri-api => k8s.io/cri-api v0.21.5
...
replace k8s.io/mount-utils => k8s.io/mount-utils v0.21.5
