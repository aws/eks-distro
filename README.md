...
| -- | --- |-------------------------------------------------------------------------|
| 11 | [v1-34-eks-11](https://distro.eks.amazonaws.com/kubernetes-1-34/kubernetes-1-34-eks-11.yaml) | [v1.34.2](https://github.com/kubernetes/kubernetes/release/tag/v1.34.2) |
### Kubernetes 1-33
