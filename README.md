...
| -- | --- |-------------------------------------------------------------------------|
| 6 | [v1-34-eks-6](https://distro.eks.amazonaws.com/kubernetes-1-34/kubernetes-1-34-eks-6.yaml) | [v1.34.1](https://github.com/kubernetes/kubernetes/release/tag/v1.34.1) |
### Kubernetes 1-33

| Release | Manifest | Kubernetes Version                                                      |
| -- | --- |-------------------------------------------------------------------------|
| 15 | [v1-33-eks-15](https://distro.eks.amazonaws.com/kubernetes-1-33/kubernetes-1-33-eks-15.yaml) | [v1.33.5](https://github.com/kubernetes/kubernetes/release/tag/v1.33.5) |

### Kubernetes 1-32

| Release | Manifest | Kubernetes Version                                                      |
| -- | --- |-------------------------------------------------------------------------|
| 25 | [v1-32-eks-25](https://distro.eks.amazonaws.com/kubernetes-1-32/kubernetes-1-32-eks-25.yaml) | [v1.32.9](https://github.com/kubernetes/kubernetes/release/tag/v1.32.9) |
