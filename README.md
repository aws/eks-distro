...
| Release | Manifest | Kubernetes Version                                                        |
| -- | --- |---------------------------------------------------------------------------|
| 31 | [v1-31-eks-31](https://distro.eks.amazonaws.com/kubernetes-1-31/kubernetes-1-31-eks-31.yaml) | [v1.31.13](https://github.com/kubernetes/kubernetes/release/tag/v1.31.13) |
