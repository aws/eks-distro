...
| Release | Manifest | Kubernetes Version                                                      |
| -- | --- |-------------------------------------------------------------------------|
| 35 | [v1-32-eks-35](https://distro.eks.amazonaws.com/kubernetes-1-32/kubernetes-1-32-eks-35.yaml) | [v1.32.12](https://github.com/kubernetes/kubernetes/release/tag/v1.32.12) |
