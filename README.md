...
| Release | Manifest | Kubernetes Version                                                      |
| -- | --- |-------------------------------------------------------------------------|
| 9 | [v1-35-eks-9](https://distro.eks.amazonaws.com/kubernetes-1-35/kubernetes-1-35-eks-9.yaml) | [v1.35.2](https://github.com/kubernetes/kubernetes/release/tag/v1.35.2) |
