...
| -- | --- |-------------------------------------------------------------------------|
| 8 | [v1-34-eks-8](https://distro.eks.amazonaws.com/kubernetes-1-34/kubernetes-1-34-eks-8.yaml) | [v1.34.1](https://github.com/kubernetes/kubernetes/release/tag/v1.34.1) |
### Kubernetes 1-33
