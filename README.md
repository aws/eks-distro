...
| Release | Manifest | Kubernetes Version                                                      |
| -- | --- |-------------------------------------------------------------------------|
| 33 | [v1-32-eks-33](https://distro.eks.amazonaws.com/kubernetes-1-32/kubernetes-1-32-eks-33.yaml) | [v1.32.11](https://github.com/kubernetes/kubernetes/release/tag/v1.32.11) |
