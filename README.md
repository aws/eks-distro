...
| -- | --- | --- |
| 0 | [v1-26-eks-0](https://distro.eks.amazonaws.com/kubernetes-1-26/kubernetes-1-26-eks-0.yaml) | [v1.26.0](https://github.com/kubernetes/kubernetes/release/tag/v1.26.0) |
