...
| Release | Manifest | Kubernetes Version                                                      |
| -- | --- |-------------------------------------------------------------------------|
| 20 | [v1-33-eks-20](https://distro.eks.amazonaws.com/kubernetes-1-33/kubernetes-1-33-eks-20.yaml) | [v1.33.5](https://github.com/kubernetes/kubernetes/release/tag/v1.33.5) |
