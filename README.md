...
| Release | Manifest | Kubernetes Version                                                      |
| -- | --- |-------------------------------------------------------------------------|
| 30 | [v1-32-eks-30](https://distro.eks.amazonaws.com/kubernetes-1-32/kubernetes-1-32-eks-30.yaml) | [v1.32.9](https://github.com/kubernetes/kubernetes/release/tag/v1.32.9) |

### Kubernetes 1-31

| Release | Manifest | Kubernetes Version                                                        |
| -- | --- |---------------------------------------------------------------------------|
| 36 | [v1-31-eks-36](https://distro.eks.amazonaws.com/kubernetes-1-31/kubernetes-1-31-eks-36.yaml) | [v1.31.13](https://github.com/kubernetes/kubernetes/release/tag/v1.31.13) |
