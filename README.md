...
| -- | --- |-------------------------------------------------------------------------|
| 5 | [v1-35-eks-5](https://distro.eks.amazonaws.com/kubernetes-1-35/kubernetes-1-35-eks-5.yaml) | [v1.35.0](https://github.com/kubernetes/kubernetes/release/tag/v1.35.0) |
...
| Release | Manifest | Kubernetes Version                                                        |
| -- | --- |---------------------------------------------------------------------------|
| 40 | [v1-31-eks-40](https://distro.eks.amazonaws.com/kubernetes-1-31/kubernetes-1-31-eks-40.yaml) | [v1.31.14](https://github.com/kubernetes/kubernetes/release/tag/v1.31.14) |
