...
./ecr-command.sh install-ecr-public
...
./ecr-command.sh create-private-repository test-repository
#./ecr-command.sh retag-private-image test-repository scratch 1.0 2.0
