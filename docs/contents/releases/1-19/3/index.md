...
immutable Secrets and ConfigMaps. A [change log](CHANGELOG-v1-19-eks-3.md) is available
describing the patches and versions included in this release.

The [EKS-D v1-19-eks-3](https://distro.eks.amazonaws.com/kubernetes-1-19/kubernetes-1-19-eks-3.yaml)
  ...
  components:
    - assets:
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/etcd/v3.4.14/etcd-linux-arm64-v3.4.14.tar.gz
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/etcd/v3.4.14/etcd-linux-amd64-v3.4.14.tar.gz
        ...
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/etcd-io/etcd:v3.4.14-eks-1-19-3
          name: etcd-image
          os: linux
          type: Image
      gitTag: v3.4.14
    ...
    - assets:
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/coredns/coredns:v1.8.0-eks-1-19-3
          name: coredns-image
          os: linux
          type: Image
      gitTag: v1.8.0
    ...
    - assets:
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/aws-iam-authenticator/v0.5.2/aws-iam-authenticator-linux-arm64-v0.5.2.tar.gz
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/aws-iam-authenticator/v0.5.2/aws-iam-authenticator-linux-amd64-v0.5.2.tar.gz
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/aws-iam-authenticator/v0.5.2/aws-iam-authenticator-windows-amd64-v0.5.2.tar.gz
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/aws-iam-authenticator/v0.5.2/aws-iam-authenticator-darwin-amd64-v0.5.2.tar.gz
        ...
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes-sigs/aws-iam-authenticator:v0.5.2-eks-1-19-3
    ...
    - assets:
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes-csi/livenessprobe:v2.2.0-eks-1-19-3
    ...
    - assets:
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes-csi/external-snapshotter/csi-snapshotter:v3.0.3-eks-1-19-3
        ...
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes-csi/external-snapshotter/snapshot-controller:v3.0.3-eks-1-19-3
        ...
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes-csi/external-snapshotter/snapshot-validation-webhook:v3.0.3-eks-1-19-3
    ...
    - assets:
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes-sigs/metrics-server:v0.4.0-eks-1-19-3
    ...
    - assets:
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/plugins/v0.8.7/cni-plugins-linux-arm64-v0.8.7.tar.gz
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/plugins/v0.8.7/cni-plugins-linux-amd64-v0.8.7.tar.gz
    ...
    - assets:
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/kubernetes-client-darwin-amd64.tar.gz
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/kubernetes-client-linux-arm64.tar.gz
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/kubernetes-server-linux-arm64.tar.gz
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/kubernetes-node-linux-arm64.tar.gz
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/kubernetes-client-linux-amd64.tar.gz
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/kubernetes-server-linux-amd64.tar.gz
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/kubernetes-node-linux-amd64.tar.gz
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/kubernetes-client-windows-amd64.tar.gz
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/kubernetes-node-windows-amd64.tar.gz
        ...
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes/kube-apiserver:v1.19.6-eks-1-19-1
        ...
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes/kube-controller-manager:v1.19.6-eks-1-19-1
        ...
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes/kube-scheduler:v1.19.6-eks-1-19-1
        ...
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes/kube-proxy:v1.19.6-eks-1-19-1
        ...
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes/pause:v1.19.6-eks-1-19-1
          name: pause-image
          os: linux
          type: Image
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/darwin/amd64/kubectl
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/arm64/kube-apiserver
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/arm64/kube-controller-manager
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/arm64/kube-proxy
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/arm64/kube-scheduler
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/arm64/kubectl
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/arm64/kubelet
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/arm64/kubeadm
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/amd64/kube-apiserver
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/amd64/kube-controller-manager
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/amd64/kube-proxy
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/amd64/kube-scheduler
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/amd64/kubectl
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/amd64/kubelet
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/amd64/kubeadm
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/windows/amd64/kube-proxy.exe
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/windows/amd64/kubeadm.exe
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/windows/amd64/kubectl.exe
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/windows/amd64/kubelet.exe
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/amd64/kube-apiserver.tar
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/arm64/kube-apiserver.tar
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/amd64/kube-controller-manager.tar
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/arm64/kube-controller-manager.tar
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/amd64/kube-scheduler.tar
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/arm64/kube-scheduler.tar
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/amd64/kube-proxy.tar
        ...
        - arch:
          ...
          archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/bin/linux/arm64/kube-proxy.tar
        ...
        - archive:
            ...
            uri: https://distro.eks.amazonaws.com/kubernetes-1-19/releases/3/artifacts/kubernetes/v1.19.6/kubernetes-src.tar.gz
    ...
    - assets:
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes-csi/external-attacher:v3.1.0-eks-1-19-3
    ...
    - assets:
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes-csi/external-provisioner:v2.1.1-eks-1-19-3
    ...
    - assets:
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes-csi/external-resizer:v1.1.0-eks-1-19-3
    ...
    - assets:
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes-csi/node-driver-registrar:v2.1.0-eks-1-19-3
