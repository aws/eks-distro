  ...
  components:
    ...
    - assets:
        ...
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes/kube-apiserver:v1.19.6-eks-1-19-3
        ...
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes/kube-controller-manager:v1.19.6-eks-1-19-3
        ...
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes/kube-scheduler:v1.19.6-eks-1-19-3
        ...
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes/kube-proxy:v1.19.6-eks-1-19-3
        ...
        - arch:
          ...
          image:
            uri: public.ecr.aws/eks-distro/kubernetes/pause:v1.19.6-eks-1-19-3
          name: pause-image
          os: linux
          type: Image
        - arch:
