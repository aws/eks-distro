...
OLDEST_SUPPORTED_BRANCH=$(firstword $(SUPPORTED_K8S_VERSIONS))

IMAGE_IMPORT_CACHE?=$(if $(filter $(GIT_TAG),$(shell cat ./$(OLDEST_SUPPORTED_BRANCH)/GIT_TAG)),$(call CACHE_IMPORT_IMAGES,$(OLDEST_SUPPORTED_BRANCH)),)
